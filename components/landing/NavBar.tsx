...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-transparent border-b-0 pointer-events-none flex justify-center py-[24px] px-4 md:px-0">
        <div
          className={`flex md:inline-flex items-center justify-between md:justify-start gap-[48px] rounded-full pointer-events-auto transition-shadow duration-300 w-full md:w-auto ${
            scrolled
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            <TrackedCTALink
              ...
              location="nav"
              className="hidden md:inline-flex items-center gap-2 bg-[#c1f879] text-[#1b1b1b] font-display font-normal text-[15px] rounded-full no-underline whitespace-nowrap flex-shrink-0 transition-opacity hover:opacity-[0.88] px-6 py-[14px] font-display-soft"
            >
